...
export class SessionService {
    ...
    static async launchSession(params) {
        ...
        const promptFile = await this.createPromptFile(worktreePath, prompt, agentName, // Pass agent name to be included in prompt
        contextFiles);
        ...
        const terminalService = createTerminalService(terminalApp ? { app: terminalApp } : undefined);
        try {
            ...
            if (!terminalResult.success) {
                throw new SessionError('Failed to create terminal', 'TERMINAL_CREATION_FAILED');
            }
