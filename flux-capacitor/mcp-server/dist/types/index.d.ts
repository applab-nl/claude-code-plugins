...
export type SessionStatus = 'active' | 'completed' | 'failed' | 'terminated' | 'unknown';
...
export declare class WorktreeError extends Error {
    ...
    constructor(message: string, code: WorktreeErrorCode, details?: unknown | undefined);
}
export type WorktreeErrorCode = 'WORKTREE_EXISTS' | 'WORKTREE_NOT_FOUND' | 'WORKTREE_DIRTY' | 'BRANCH_EXISTS' | 'BRANCH_NOT_FOUND' | 'REPOSITORY_NOT_FOUND' | 'GIT_ERROR' | 'INIT_SCRIPT_FAILED' | 'MAX_WORKTREES_EXCEEDED';
export declare class SessionError extends Error {
    code: SessionErrorCode;
    details?: unknown | undefined;
    constructor(message: string, code: SessionErrorCode, details?: unknown | undefined);
}
export type SessionErrorCode = 'SESSION_NOT_FOUND' | 'SESSION_ALREADY_EXISTS' | 'TERMINAL_CREATION_FAILED' | 'CLAUDE_LAUNCH_FAILED' | 'INVALID_WORKTREE';
export declare class TerminalError extends Error {
    code: TerminalErrorCode;
    details?: unknown | undefined;
    constructor(message: string, code: TerminalErrorCode, details?: unknown | undefined);
}
export type TerminalErrorCode = 'NO_TERMINAL_AVAILABLE' | 'TERMINAL_NOT_FOUND' | 'COMMAND_EXECUTION_FAILED' | 'INVALID_CONFIGURATION';
